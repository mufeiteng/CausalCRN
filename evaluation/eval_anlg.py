from CausalCRN.evaluation.bleu.bleu import Bleu
from CausalCRN.evaluation.meteor.meteor_nltk import Meteor
from CausalCRN.evaluation.rouge.rouge import Rouge
from CausalCRN.evaluation.cider.cider import Cider
from CausalCRN.evaluation.bert_score.bert_score import BertScore
...
def eval_nli(samples, ent_model_path, batch_size=16, verbose=False):
    from CausalCRN.evaluation.eval_client.nli_metrics.entail_score import EntailScore
...
def do_eval_from_json_samples_merged_hypos(samples, metrics):
    ...
    if 'entail' in metrics:
        import os
        from CausalCRN.tools import project_data_path
